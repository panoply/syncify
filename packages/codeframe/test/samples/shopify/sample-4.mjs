export const test = 'Unexpected character = in "*"';
export const message =
`Liquid syntax error (line 101): Unexpected character = in "section.settings.show_bag == true
  ...
  "settings": [
    {
      "type": "header",
      "content": "Style",
      "info": "Controls the rendered style of the navbar header"
    },
    {
      "type": "select",
      "id": "theme",
      "label": "Theme",
      "default": "",
      "info": "The navbar theming to apply",
      "options": [
        {
          "value": "",
          "label": "White"
    ...
    },
    {
      ...
      "info": "Control the visibility of additional links"
    },
    {
      "type": "checkbox",
      "id": "show_bag",
      "label": "Shopping Bag",
      "info": "Whether or not to render the the shopping bag button",
      "default": true
    },
    {
      "type": "checkbox",
      "id": "show_locale",
      "label": "Locales",
      "info": "Whether or not to render the locale country button",
      "default": true
    }
  ]
}
