export const test = 'Variable \'{{ settings.body_font | font_face %}\' was not properly terminated with regexp';

export const message = "Liquid syntax error (line 17): Variable '{{ settings.body_font | font_face %}' was not properly terminated with regexp: /\\}\\}/";
