...
export type SettingsGroup = { $description?: SharedSchemaDescription; settings: SchemaSettings[] }
export type SettingsSpread = SchemaSettings[]
export type SettingsSingleton = SchemaSettings
export type BlockSpread = SchemaBlocks[]
export type BlockSingleton = SchemaBlocks
export type SharedSchemaRefs = (
  | SettingsGroup
  | SettingsSpread
  | SettingsSingleton
  | BlockSpread
...
export interface SchemaTemplateSections {
  [k: string]: {
    /**
...
export interface SchemaTemplates {
   ...
   * The section data
   */
  sections: SchemaTemplateSections;
}
