 ...
 * Metafield Types
 */
export type MetafieldTypes = LiteralString<(
  | 'boolean'
  | 'color'
  | 'date'
  | 'date_time'
...
/**
 * Shopify theme asset paths, we use this to when re-pathing custom directories.
 */
export type AssetKeys = LiteralString<(
 ...
 */
export type ThemeRole = LiteralString<(
  | 'main'
  | 'unpublished'
  | 'demo'
  | 'development'
...
export type AccessScopes = LiteralString<
  | 'read_files'
  | 'write_files'
...
export namespace Resource {
  ...
  export type AssetFields = LiteralString<Join<[
    'key',
    'public_url',
    'created_at',
    'updated_at',
  ...
  export type ThemeFields = LiteralString<Join<[
    'id',
    'theme_store_id',
    'created_at',
    'updated_at',
  ...
  export type PageFields = LiteralString<Join<
    [
      'author',
      'body_html',
      'created_at',
...
export namespace LIST {
  ...
  export interface PageParams {
     ...
     */
    published_status?: LiteralString<'published' | 'unpublished' | 'any'>;
    /**
...
export namespace Requests {
  ...
  export type Access<M extends 'GET'> = AxiosRequestConfig<{
    url?: LiteralString<RequestUrls['access'][M]>;
    method?: Lowercase<M>;
    responseType?: 'json',
  ...
  export type Asset<M extends RequestMethods> = AxiosRequestConfig<{
    url?: LiteralString<RequestUrls['asset'][M]>;
  ...
  export type Page<M extends RequestMethods> = AxiosRequestConfig<{
    url?: LiteralString<RequestUrls['page'][M]>;
    method?: Lowercase<M>;
    responseType?: 'json',
