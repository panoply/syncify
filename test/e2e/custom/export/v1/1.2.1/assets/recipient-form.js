...
// src/scripts/dawn/recipient-form.js
  ...
  customElements.define(
    ...
    class RecipientForm extends HTMLElement {
      constructor() {
        ...
        __publicField(this, "cartErrorUnsubscriber");
        ...
        this.errorMessage = (_b = this.errorMessageWrapper) == null ? void 0 : _b.querySelector(".error-message");
        this.defaultErrorHeader = (_c = this.errorMessage) == null ? void 0 : _c.innerText;
      ...
      displayErrorMessage(title, body) {
        ...
        if (typeof body === "object") {
          ...
          return Object.entries(body).forEach(([key, value]) => {
            ...
            const errorTextElement = errorMessageElement == null ? void 0 : errorMessageElement.querySelector(".error-message");
            if (!errorTextElement)
              return;
