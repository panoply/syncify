...
var FacetFiltersForm = class _FacetFiltersForm extends HTMLElement {
  ...
  static setListeners() {
    const onHistoryChange = (event) => {
      const searchParams = event.state ? event.state.searchParams : _FacetFiltersForm.searchParamsInitial;
  ...
  static renderFilters(html, event) {
    ...
    if (countsToRender)
      _FacetFiltersForm.renderCounts(countsToRender, event.target.closest(".js-filter"));
  }
