...
var MenuDrawer = class extends HTMLElement {
  ...
  closeMenuDrawer(event, elementToFocus = false) {
    ...
    if (event instanceof KeyboardEvent)
      elementToFocus == null ? void 0 : elementToFocus.setAttribute("aria-expanded", false);
  }
  onFocusOut() {
    setTimeout(() => {
...
var HeaderDrawer = class extends MenuDrawer {
  constructor() {
    ...
    __publicField(this, "onResize", () => {
      this.header && document.documentElement.style.setProperty(
...
var VariantSelects = class extends HTMLElement {
  ...
  updateMedia() {
    ...
    mediaGalleries.forEach(
      (mediaGallery) => mediaGallery.setActiveMedia(`${this.dataset.section}-${this.currentVariant.featured_media.id}`, true)
    );
