...
module.exports = function * (argv) {
  ...
  fancyLog(chalk`{green.bold SHOPIFY SYNC}`)
  fancyLog(chalk`Watching {green ${directory}/**/**} directory.`)
  fancyLog(chalk`Targeting {green ${target.target_name}} at {green ${target.domain}.myshopify.com}`)
