...
module.exports = function*(config) {
    ...
    You can use a '.gitignore' file which allows you to have all your ignores in one place or you can use a '.syncignore'. Which allows git and shopify sync to ignore different files.
