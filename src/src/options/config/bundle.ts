...
import { ICLICommands, IOptions, IPackage } from 'types';
...
import { is, isArray, keys } from '../../utils/native';
 ...
 * working directory.
 */
export async function getStores (cli: ICLICommands, config: IOptions) {
 ...
 */
export async function getPaths (config: IOptions) {
