...
##### Sections Rename `{js} { '[dir]-[name]': 'sections/product/*' }`
...
##### Snippets Wildcard `{js} { '[name]': 'snippets/**/*' }`
...
##### Sections Rename `{js} { 'card.[name]': 'snippets/all-cards/*' }`
