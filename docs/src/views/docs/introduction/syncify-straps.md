...
title: 'Introduction'
layout: base.liquid
permalink: '/syncify-straps/index.html'
anchors:
  - 'What is Syncify?'
  - 'Key Features'
...
Theme straps from Syncify are comprehensive, fully-developed themes intended to serve as starting points for developers. While Shopify provides developers with the [Dawn](https://github.com/shopify/dawn) theme, Syncify extends this offering with four different boilerplates (one of which is Syncify X Dawn). These theme straps are designed to be plug-and-play, coming pre-configured and ready for immediate use.
