...
export function Default () {
  ...
  .Line(` $ sy publish                    ${describe('Changes a theme role to and makes it main')}`)
  .Line(` $ sy delete                     ${describe('Remove files/resources from a store or theme')}`)
  .Line(` $ sy pack                       ${describe('Generate a .zip package of the current theme')}`)
  .Line(` $ sy link                       ${describe('Link existing themes/s from a store')}`)
  .Line(` $ sy unlink                     ${describe('Remove a linked theme/s from project')}`)
  ...
  .Line(` $ sy git                        ${describe('Git integration configuration and information')}`)
  .Line(` $ sy prune                      ${describe('Clears internal project caches from disk')}`)
  ...
  .Line(` $ sy doctor                     ${describe('Diagnostics and fixable operations')}`)
