...
var require_picocolors = __commonJS({
  "node_modules/.pnpm/picocolors@1.1.0/node_modules/picocolors/picocolors.js"(exports, module) {
    ...
    var env = process.env;
    var isColorSupported = !("NO_COLOR" in env || argv2.includes("--no-color")) && ("FORCE_COLOR" in env || argv2.includes("--color") || process.platform === "win32" || __require != null && __require("tty").isatty(1) && env.TERM !== "dumb" || "CI" in env);
