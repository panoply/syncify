...
var require_picocolors = __commonJS({
  "node_modules/.pnpm/picocolors@1.0.1/node_modules/picocolors/picocolors.js"(exports, module) {
    ...
    var isColorSupported = !("NO_COLOR" in env2 || argv4.includes("--no-color")) && ("FORCE_COLOR" in env2 || argv4.includes("--color") || process.platform === "win32" || __require != null && __require("tty").isatty(1) && env2.TERM !== "dumb" || "CI" in env2);
...
async function getEnvFile(cli) {
  ...
  if (await pathExists3(path2)) {
    const env2 = dotenv.config({ path: path2 });
    if (env2.error) {
