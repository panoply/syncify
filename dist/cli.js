...
function cmd(args, options) {
  const { values: values2, tokens: tokens2 } = (0, import_node_util2.parseArgs)({
    args,
    options,
...
function authURL(domain) {
  ...
  throwError(
    ...
    [
      `Your shop credentials in the ${import_ansi8.cyan.bold((0, import_node_path6.basename)($.env.file))} file could`,
