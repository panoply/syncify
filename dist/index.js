...
var require_ansis = __commonJS({
  "node_modules/.pnpm/ansis@3.3.2/node_modules/ansis/index.js"(exports2, module2) {
    ...
    var { round: e2, floor: t2, max: n } = Math;
    var r = (e3) => {
      let [, t3] = /([a-f\d]{3,6})/i.exec(e3) || [], n2 = t3 ? t3.length : 0;
      if (3 === n2) t3 = t3[0] + t3[0] + t3[1] + t3[1] + t3[2] + t3[2];
      else if (6 !== n2) return [0, 0, 0];
      let r2 = parseInt(t3, 16);
      return [r2 >> 16 & 255, r2 >> 8 & 255, 255 & r2];
    };
    var i = (t3, n2, r2) => t3 === n2 && n2 === r2 ? t3 < 8 ? 16 : t3 > 248 ? 231 : e2((t3 - 8) / 247 * 24) + 232 : 16 + 36 * e2(t3 / 51) + 6 * e2(n2 / 51) + e2(r2 / 51);
    var o2 = (r2) => {
      let i2, o3, l2, s2, c2, u2;
      return r2 < 8 ? 30 + r2 : r2 < 16 ? r2 - 8 + 90 : (r2 >= 232 ? i2 = o3 = l2 = (10 * (r2 - 232) + 8) / 255 : (u2 = (r2 -= 16) % 36, i2 = t2(r2 / 36) / 5, o3 = t2(u2 / 6) / 5, l2 = u2 % 6 / 5), s2 = 2 * n(i2, o3, l2), 0 === s2 ? 30 : (c2 = 30 + (e2(l2) << 2 | e2(o3) << 1 | e2(i2)), 2 === s2 ? c2 + 60 : c2));
    };
    var l = (e3, t3, n2) => o2(i(e3, t3, n2));
    var s = ((e3) => {
      const t3 = (e4) => !!c2.find((t4) => e4.test(t4)), n2 = globalThis, r2 = n2.Deno, i2 = null != r2, o3 = n2.process || r2 || {}, l2 = o3.stdout, s2 = "win32" === (i2 ? r2.build.os : o3.platform), c2 = o3.argv || o3.args || [];
      let u2 = o3.env || {}, a2 = -1;
      if (i2) try {
        u2 = u2.toObject();
      } catch (e4) {
      ...
      const p2 = "FORCE_COLOR", g2 = u2[p2], f2 = parseInt(g2), d2 = "false" === g2 ? 0 : isNaN(f2) ? 3 : f2, b2 = "NO_COLOR" in u2 || 0 === d2 || t3(/^-{1,2}(no-color|color=(false|never))$/), _2 = p2 in u2 && d2 || t3(/^-{1,2}color=?(true|always)?$/), O2 = (u2.NEXT_RUNTIME || "").indexOf("edge") > -1 || "PM2_HOME" in u2 && "pm_id" in u2 || (i2 ? r2.isatty(1) : l2 && "isTTY" in l2);
      return b2 ? 0 : (a2 < 0 && (a2 = ((e4, t4, n3) => {
        const { TERM: r3, COLORTERM: i3 } = e4;
        return "TF_BUILD" in e4 ? 1 : "TEAMCITY_VERSION" in e4 ? 2 : "CI" in e4 ? ["GITHUB_ACTIONS", "GITEA_ACTIONS"].some((t5) => t5 in e4) ? 3 : 1 : !t4 || /-mono|dumb/i.test(r3) ? 0 : n3 || "truecolor" === i3 || "24bit" === i3 || "xterm-kitty" === r3 ? 3 : /-256(colou?r)?$/i.test(r3) ? 2 : /^screen|^tmux|^xterm|^vt[1-5][0-9]([0-9])?|^ansi|color|cygwin|linux|mintty|rxvt/i.test(r3) ? 1 : 3;
      })(u2, O2, s2)), _2 && 0 === a2 ? 3 : a2);
    })();
    var c = s > 0;
    var u = { open: "", close: "" };
    var a = c ? (e3, t3) => ({ open: `\x1B[${e3}m`, close: `\x1B[${t3}m` }) : () => u;
    var p = 39;
    var g = 49;
    var f = (e3) => (t3, n2, r2) => e3(i(t3, n2, r2));
    var d = (e3) => (t3) => {
      let [n2, i2, o3] = r(t3);
      return e3(n2, i2, o3);
    };
    var b = (e3) => a(`38;5;${e3}`, p);
    var _ = (e3) => a(`48;5;${e3}`, g);
    var O = (e3, t3, n2) => a(`38;2;${e3};${t3};${n2}`, p);
    var y = (e3, t3, n2) => a(`48;2;${e3};${t3};${n2}`, g);
    1 === s ? (b = (e3) => a(o2(e3), p), _ = (e3) => a(o2(e3) + 10, g), O = (e3, t3, n2) => a(l(e3, t3, n2), p), y = (e3, t3, n2) => a(l(e3, t3, n2) + 10, g)) : 2 === s && (O = f(b), y = f(_));
    var m;
    var x;
    ...
    var w = /(\r?\n)/g;
    var M = {};
    var N = ({ _p: e3 }, { open: t3, close: n2 }) => {
      const r2 = (e4, ...t4) => {
        if (!e4) return "";
        let n3 = r2._p, { _a: i3, _b: o4 } = n3, l2 = null != e4.raw ? String.raw(e4, ...t4) : "" + e4;
        if (l2.includes("\x1B")) for (; null != n3; ) {
          let e5 = n3.close, t5 = e5.length;
          if (t5) {
            let r3, i4 = 0, o5 = "";
            for (; ~(r3 = l2.indexOf(e5, i4)); ) o5 += l2.slice(i4, r3) + n3.open, i4 = r3 + t5;
            i4 && (l2 = o5 + l2.slice(i4));
          }
          n3 = n3._p;
        }
        return l2.includes("\n") && (l2 = l2.replace(w, o4 + "$1" + i3)), i3 + l2 + o4;
      };
      let i2 = t3, o3 = n2;
      return null != e3 && (i2 = e3._a + t3, o3 = n2 + e3._b), C(r2, P), r2._p = { open: t3, close: n2, _a: i2, _b: o3, _p: e3 }, r2.open = i2, r2.close = o3, r2;
    };
    var A = function() {
      const e3 = (e4) => "" + e4;
      return e3.isSupported = () => c, e3.strip = (e4) => e4.replace(E, ""), e3.extend = (t3) => {
        for (let e4 in t3) {
          let n2 = t3[e4], i2 = typeof n2, o3 = "string" === i2 ? O(...r(n2)) : n2;
          M[e4] = "function" === i2 ? { get() {
            return (...e5) => N(this, n2(...e5));
          } } : { get() {
            let t4 = N(this, o3);
            return R(this, e4, { value: t4 }), t4;
          } };
        }
        P = v({}, M), C(e3, P);
      }, e3.extend(h), e3;
...
var require_anymatch = __commonJS({
  "node_modules/.pnpm/anymatch@3.1.3/node_modules/anymatch/index.js"(exports2, module2) {
    ...
    var anymatch7 = (matchers, testString, options = DEFAULT_OPTIONS) => {
      if (matchers == null) {
    ...
    anymatch7.default = anymatch7;
    module2.exports = anymatch7;
  }
});
...
var require_picocolors = __commonJS({
  "node_modules/.pnpm/picocolors@1.0.1/node_modules/picocolors/picocolors.js"(exports2, module2) {
    ...
    var isColorSupported = !("NO_COLOR" in env3 || argv4.includes("--no-color")) && ("FORCE_COLOR" in env3 || argv4.includes("--color") || process.platform === "win32" || require != null && require("tty").isatty(1) && env3.TERM !== "dumb" || "CI" in env3);
...
// node_modules/.pnpm/rambdax@11.1.1/node_modules/rambdax/src/allFalse.js
init_cjs_shims();

// node_modules/.pnpm/rambdax@11.1.1/node_modules/rambdax/src/_internals/isTruthy.js
init_cjs_shims();

// node_modules/.pnpm/rambdax@11.1.1/node_modules/rambdax/src/type.js
init_cjs_shims();
function type(input) {
  if (input === null) {
    return "Null";
...
// node_modules/.pnpm/rambdax@11.1.1/node_modules/rambdax/src/_internals/isArray.js
init_cjs_shims();
var { isArray } = Array;
...
// node_modules/.pnpm/rambdax@11.1.1/node_modules/rambdax/src/allTrue.js
init_cjs_shims();

// node_modules/.pnpm/rambdax@11.1.1/node_modules/rambdax/src/_internals/isFalsy.js
init_cjs_shims();
function isFalsy(x) {
  if (isArray(x)) {
    return x.length === 0;
...
// node_modules/.pnpm/rambdax@11.1.1/node_modules/rambdax/src/anyTrue.js
init_cjs_shims();
...
// node_modules/.pnpm/rambdax@11.1.1/node_modules/rambdax/src/_internals/createPath.js
init_cjs_shims();

// node_modules/.pnpm/rambdax@11.1.1/node_modules/rambdax/src/_internals/isInteger.js
init_cjs_shims();
...
// node_modules/.pnpm/rambdax@11.1.1/node_modules/rambdax/src/path.js
init_cjs_shims();
...
// node_modules/.pnpm/rambdax@11.1.1/node_modules/rambdax/src/equals.js
init_cjs_shims();
...
// node_modules/.pnpm/rambdax@11.1.1/node_modules/rambdax/src/delay.js
init_cjs_shims();
...
// node_modules/.pnpm/rambdax@11.1.1/node_modules/rambdax/src/includes.js
init_cjs_shims();
...
// node_modules/.pnpm/rambdax@11.1.1/node_modules/rambdax/src/isType.js
init_cjs_shims();
...
// node_modules/.pnpm/rambdax@11.1.1/node_modules/rambdax/src/mapParallelAsync.js
init_cjs_shims();
...
// node_modules/.pnpm/rambdax@11.1.1/node_modules/rambdax/src/omit.js
init_cjs_shims();

// node_modules/.pnpm/rambdax@11.1.1/node_modules/rambdax/src/_internals/includes.js
init_cjs_shims();

// node_modules/.pnpm/rambdax@11.1.1/node_modules/rambdax/src/_internals/compare.js
init_cjs_shims();
...
// node_modules/.pnpm/rambdax@11.1.1/node_modules/rambdax/src/has.js
init_cjs_shims();
...
// node_modules/.pnpm/rambdax@11.1.1/node_modules/rambdax/src/hasPath.js
init_cjs_shims();
...
// node_modules/.pnpm/rambdax@11.1.1/node_modules/rambdax/src/isEmpty.js
init_cjs_shims();
...
// node_modules/.pnpm/rambdax@11.1.1/node_modules/rambdax/src/isNil.js
init_cjs_shims();
function isNil(x) {
  return x === void 0 || x === null;
}

// node_modules/.pnpm/rambdax@11.1.1/node_modules/rambdax/src/last.js
init_cjs_shims();
...
var {
  ...
  warn,
  clear
} = new import_node_console.Console(import_node_process.stdout, import_node_process.stderr);
var {
  create,
  assign,
  defineProperty,
...
function plural(word, size2) {
  if (size2 >= 2) return word[word.length - 1] !== "s" ? `${word}s` : word;
...
var t = (e2, r, s) => {
  const c = typeof s;
  if (s && "object" === c) if (Array.isArray(s)) for (const o2 of s) r = t(e2, r, o2);
  else for (const c2 of Object.keys(s)) {
    const f = s[c2];
...
function Top(label) {
  return Tree.open + reset2.gray(`${label} ~ ${getTime()}`);
}
function Wrap(...input) {
...
function End(input) {
  return Tree.base + reset2.gray(`${input} ~ ${getTime()}`) + "\n";
}
...
var Message = class {
  ...
  Newline(line2, color) {
    if (isNumber(line2)) {
      ...
      for (let i = 0; i < line2; i++) this.text.push(input);
    } else {
      if (line2 === "") {
        this.text.push("\n");
      } else if (line2 === "line") {
...
function Sample(code, {
  ...
  if (span !== null) {
    ...
    return line2 + "\n" + [
      line2 + blue2(`${span.start - 1}`) + COL,
      line2 + blue2(`${span.start}`) + COL + code,
      line2 + blue2(`${end}`) + COL
    ].join("\n");
  }
  return line2 + "\n" + line2 + code;
...
function highlight(string) {
  return redBright2(string.replace(/('[{}_\w\s.-]*?'|"[\w\s.-]*?")/g, orange("$1")).replace(/({{2}-?[a-zA-Z0-9_\-.'"[\]]+-?}{2})/g, teal("$1")).replace(/((?:www|http:|https:)+[^\s]+[\w])/g, underline2("$1")).replace(/(\/)(.*?)(\/)/g, teal("$1") + neonCyan("$2") + teal("$3")).replace(/(\\)(\W)/g, gray2("$1") + neonCyan("$2")).replace(/(:)(?= )/g, gray2("$1")).replace(/(?<=Filename\s)([\w._-]+)(?=\salready)/, neonCyan.bold("$1")));
}
function tokens(string) {
  return string.replace(/({%|{%-}|-%}|%}|{{|{{-|}}|-}}|<\/?|>|:|,)/g, neonCyan("$1")).replace(/(['"].*?['"])/g, gray2("$1"));
}
  ...
  if (e2.status === 422) {
    ...
    const context2 = object({
      ...
      entries: object({
        ...
        status: white2(sanitize(e2.status)),
...
function throws(e2, entries) {
  ...
  if (has2("stack", e2)) context.stack = e2.stack;
  if (has2("code", e2)) context.entries.code = e2.code;
  if (has2("name", e2)) context.entries.name = e2.name;
    ...
    while (lines.length !== 0) {
      if (has2("line", entries) === false) {
        ...
        if (raw[0] === ">") {
          ...
          if (number !== null) line2 = Number(number[0]);
        }
      }
...
function sass(file, e2) {
  const message = Create({ type: "error" }).NL.Wrap(e2.sassMessage, red2.bold).Newline();
  if (has2("span", e2)) {
    const { span } = e2;
    ...
    if (start.line === end.line) {
      ...
      for (const line2 of lines) {
        ...
        message.Line(`${align + blue2(number)} ${Tree.trim} ${line2}`);
      }
    }
  }
  error(
...
function esbuild(e2) {
  const message = Create({ type: "error" }).NL.Wrap(e2.text, red2.bold).Newline();
...
function postcss(file, e2) {
  ...
  $.errors.add(stack.join("\n"));
  error(
    Create({ type: "error" }).NL.Wrap(`${e2.name}${COL} ${e2.reason}`, red2.bold).Newline().Multiline(e2.showSourceCode(true)).NL.NL.Context({
      stack: true,
      entries: {
        line: e2.line,
        column: e2.column,
...
function missingOption({
  ...
  error(
    Create({ type: "error" }).Line("MISSING OPTION", bold2).NL.Wrap(`Missing ${Encase("CB", cyan2(option))} config option. The ${cyan2(key)} option needs to be defined`).NL.Line(`expected${COL} ${blue2(expects.replace(/([|,])/g, gray2("$1")))}`).Line(`location${COL} ${gray2.underline($.file.base)}`).NL.Line("Why?", gray2.bold).Wrap(reason, gray2).End($.log.group).BR.toString()
  );
  process.exit(0);
}
...
runtime.warnings = function getRuntimeWarnings($2) {
  ...
  const message = Create({
    type: "warning"
  }).Line(`${amount} ${plural("Warning", amount)}`, bold2);
...
function process7(label, ...message) {
...
async function sync(theme3, file, config) {
  ...
  const promise = await axios(config).then(({ headers, data }) => {
    ...
    if (config.method === "delete") {
      ...
      if ($.mode.watch) {
        if ($.mode.hot === true && file.type !== 10 /* Script */ && file.type !== 9 /* Style */) hot();
        upload(theme3);
      } else if ($.mode.upload) {
        event.emit("upload", {
          status: 0 /* Success */,
    ...
    if (e2.response && (e2.response.status === 429 || e2.response.status === 500)) {
      if ($.mode.upload === false && $.mode.import === false) retrying(file.key, theme3);
...
async function create3(store, metafield) {
  ...
  return import_axios2.default.post("metafields.json", { metafield }, store.client).then(({ data }) => {
    ...
    console.log(e2);
    if (!store.queue) return request(metafield.namespace, e2.response);
...
async function sync2(store, field) {
  ...
  return update(store, data.id, assign(field, { id: data.id, type: "json" })).catch((e2) => {
    if (!store.queue) return request(field.namespace, e2.response);
    if (requeue(e2.response.status)) {
...
function normalPath(input, cwd = null) {
  ...
  return function prepend(path2) {
    if (isArray2(path2)) return path2.map(prepend);
...
var getErrorLocation = (string, message) => {
  ...
  let { index, line: line2, column } = match2.groups;
  if (line2 && column) {
  ...
  if (has2("span", options)) {
    ...
    if (lines.length < 15) {
      ...
      for (const line2 of lines) {
        ...
        const same = space - number.length;
        const align = same === 0 ? "" : " ".repeat(same);
        output.Trim(`   ${align + blue2(number)} ${Tree.trim} ${line2}`);
      }
    }
  }
...
function write3(file, sync4, cb) {
  const scope = isFunction(cb) ? { ...file } : false;
  return async function(data) {
    if (isNil2(data)) return null;
    let content;
    if (scope !== false) {
      const update2 = cb.apply({ ...file }, toBuffer(data));
      if (isUndefined(update2) || update2 === false) {
        content = data;
    ...
    (0, import_fs_extra6.writeFile)(file.output, content).catch(
...
async function sassProcess(file) {
  ...
  if (isUndefined(data)) return readStyleFile(file);
  const options = isObject(data.sass) ? merge($.processor.sass.config, data.sass) : $.processor.sass.config;
...
async function tailwindParse(file, queue2) {
  for (const map in $.processor.tailwind.map) {
    if ($.processor.tailwind.map[map].has(file.input)) {
      ...
      if (isString(style2)) queue2.push([item, style2]);
    }
  }
  return queue2;
}
...
async function compile3(file, sync4, cb) {
  ...
  try {
    ...
    if (isNil2(import_postcss.default) || !file.data.postcss && !file.data.snippet) {
...
async function htmlMinify(file, content) {
  try {
    const htmlmin = await (0, import_html_minifier_terser.minify)(content, $.terser.markup);
    return htmlmin;
  } catch (e2) {
    invalid(file.relative);
    console.error(e2);
...
async function esbuildBundle(config) {
  config.watch.clear();
  const result = await import_esbuild.default.build(config.esbuild);
...
async function getWatchPaths(config, inputs) {
  ...
  for (const file in inputs) {
    ...
    if (!config.watch.has(path2)) config.watch.add(path2);
  ...
  if (mode.watch) {
    await pNext().then(() => {
      for (const path2 of config.watch) {
        ...
        if (config.watchCustom !== null && config.watchCustom(path2)) continue;
  ...
  for (const config of file.data) {
    ...
    try {
      const {
        ...
        outputFiles,
        warnings: warnings2
      } = await import_esbuild.default.build(config.esbuild);
      if (trigger2 > 1) {
        nwl();
      ...
      for (const { text, path: path2 } of outputFiles) {
        if (path2.endsWith(".map")) {
          ...
          (0, import_fs_extra9.writeFile)(map, text).catch(
          ...
          if ($.mode.hot) {
            syncing(key, { hot: true });
            $.wss.script(file.uuid, (0, import_pathe12.basename)(key));
    ...
    for (const prop of [
      ...
      if (prop === "type") {
        ...
        if (!checkMetafieldType(type2)) {
          invalid(file.relative, [
            `Invalid type ${blue2.bold(type2)} provided in a page frontmatter ${yellowBright2.bold("metafields")}`,
...
async function getEnvFile(cli) {
  ...
  if (await (0, import_fs_extra15.pathExists)(path2)) {
    const env3 = import_dotenv.default.config({ path: path2 });
    if (env3.error) {
      throws(env3.error, { path: path2 });
      return null;
    }
    $.env.file = path2;
    $.env.vars = env3.parsed;
  } else {
    path2 = (0, import_pathe18.join)(cli.cwd, "syncify.env");
    if (await (0, import_fs_extra15.pathExists)(path2)) {
      const env3 = import_dotenv.default.config({ path: path2 });
      if (env3.error) {
        throws(env3.error.message, { path: path2 });
        return null;
      }
      $.env.file = path2;
      $.env.vars = env3.parsed;
...
var import_ngrok = __toESM(require("ngrok"));
var import_prompts4 = __toESM(require("prompts"));
async function publish(cb) {
  await exporting(cb);
  timer.start("publish");
  title("Publishing");
  const versions = (0, import_serve_static.default)($.vc.dir);
  const server2 = import_node_http.default.createServer((req, res) => versions(req, res, (0, import_finalhandler.default)(req, res)));
  const onerror = (e2) => {
  ...
  await delay(500);
  timer.start("ngrok");
  const url = await import_ngrok.default.connect({
    addr: $.publish.tunnelPort,
    onStatusChange(status) {
      if (status === "closed") {
        write2("disconnect", { prefix: "ngrok" });
      } else {
        write2(`${bold2("connected")} PORT${COL}${$.publish.tunnelPort}`, {
          prefix: "ngrok",
  ...
  server2.close();
  await import_ngrok.default.disconnect();
  nwl();
  group();
  nwl();
...
init_cjs_shims();
var import_node_http2 = __toESM(require("http"));
var import_serve_static2 = __toESM(require("serve-static"));
var import_finalhandler2 = __toESM(require("finalhandler"));
...
async function injection() {
  ...
  if (snippet2) {
    ...
    for (const layout in $.hot.alive) {
      const exists2 = await (0, import_fs_extra17.pathExists)(layout);
      if (!exists2) {
        log_update_default(Line(gray2("layout has not yet been bundled, building now...")));
        const files = import_fast_glob5.default.sync($.config.paths.layout, {
          cwd: $.dirs.input,
          absolute: true
        });
        for (const input of files) {
          if ((0, import_pathe20.basename)(input) === (0, import_pathe20.basename)(layout)) {
            const source = await (0, import_fs_extra17.readFile)(input);
            await (0, import_fs_extra17.writeFile)(layout, source);
          }
        }
...
async function server() {
  ...
  const assets = (0, import_serve_static2.default)((0, import_pathe20.join)($.dirs.output, "assets"), { setHeaders });
  const server2 = import_node_http2.default.createServer((req, res) => assets(req, res, (0, import_finalhandler2.default)(req, res)));
  const localhost = `http://localhost:${$.hot.server}`;
  const onerror = (e2) => {
    if (e2.code === "EADDRINUSE") {
      HOTError.output.push(
        Tree.red + redBright2(`${bold2("EADDRINUSE")} ${ARR} ${localhost}`),
        Tree.red,
        Tree.red + redBright2.bold(`Server Port ${$.hot.server} address already in use`),
        Tree.red,
        Tree.red + redBright2("Change the server port address or kill the session occupying it."),
        Tree.red + redBright2("This error typically occurs when multiple Syncify instances are active.")
      );
      log_update_default.clear();
      log(HOTError.output.join("\n"));
  ...
  const port = `${gray2("PORT")}  ${ARR} ${pink(`${$.hot.server}`)}`;
  const sock = `${gray2("PORT")}  ${ARR} ${pink(`${$.hot.socket}`)}`;
  log_update_default(Line(`${neonCyan("server")}  ${ARR}  ${port}`));
  log(Line(`${neonCyan("socket")}  ${ARR}  ${sock}`));
  for (const p in $.hot.alive) {
    log(Line(`${neonCyan("layout")}  ${ARR}  ${gray2((0, import_pathe20.relative)($.cwd, p))}`));
  }
  nwl();
}
function socket() {
  if ($.mode.hot === false) return;
  const wss = new import_ws.Server({
    port: $.hot.socket,
    path: "/ws",
  ...
  const onerror = (error3) => {
    if (error3.code === "EADDRINUSE") {
      ...
      HOTError.output.push(
        Tree.red + redBright2(`${bold2("EADDRINUSE")} ${ARR} ws://localhost:${$.hot.server}`),
        Tree.red,
        Tree.red + redBright2.bold(`Socket Port ${$.hot.server} address already in use`)
      );
    }
  };
  const onclose = () => {
...
async function setThemeDirs(basePath2) {
  ...
  const hasBase = await (0, import_fs_extra18.pathExists)(basePath2);
  if (hasBase) {
    if ($.mode.clean) {
      try {
  ...
  for (const dir of THEME_DIRS) {
    const uri = (0, import_pathe21.join)(basePath2, dir);
...
function setBaseDirs(cli) {
  ...
  for (const [dir, def] of BASE_DIRS) {
    let path2;
    if (dir === "cache") {
      $.dirs[dir] = (0, import_pathe21.join)($.cwd, def, ".syncify");
      $.dirs.sourcemaps = create(null);
      $.dirs.sourcemaps.root = (0, import_pathe21.join)($.dirs[dir], "sourcemaps");
      $.dirs.sourcemaps.scripts = (0, import_pathe21.join)($.dirs.sourcemaps.root, "scripts");
      $.dirs.sourcemaps.styles = (0, import_pathe21.join)($.dirs.sourcemaps.root, "styles");
      continue;
    }
    if (dir === "import") {
      if ($.mode.import) {
...
async function setImportDirs() {
  ...
  const hasBase = await (0, import_fs_extra18.pathExists)(dirs.import);
  if (!hasBase) {
    try {
  ...
  for (const theme3 in sync4.themes) {
    ...
    const dir = (0, import_pathe21.join)(dirs.import, store);
    const has3 = await (0, import_fs_extra18.pathExists)(dir);
    if (has3) {
      if (mode.clean) {
        try {
    ...
    await setThemeDirs((0, import_pathe21.join)(dir, target));
  }
}
async function createDirs(path2) {
  if (isArray2(path2)) {
    ...
    const has3 = await (0, import_fs_extra18.pathExists)(path2);
    if (!has3) {
      try {
...
function setJsonOptions() {
  if (!has2("processors", $.config)) return;
  if (!has2("json", $.config.processors)) return;
  const { json: json2 } = $.config.processors;
  if (isNil2(json2)) return;
  if (isObject(json2) && isEmpty2(json2)) return;
  if (!isObject(json2)) {
    typeError(
      {
        option: "processors",
  ...
  for (const option in json2) {
    ...
    if (option === "exclude") {
      ...
      if (isArray2(exclude)) {
        $.processor.json[option] = (0, import_anymatch2.default)(exclude);
        continue;
      } else {
        typeError(
          {
...
function setSnippetOptions() {
  if (!has2("snippets", $.config.views)) return;
  const { snippets } = $.config.views;
  if (isNil2(snippets)) return;
  if (isObject(snippets) && isEmpty2(snippets)) return;
...
async function setSectionOptions() {
  if (!has2("sections", $.config.views)) return;
  const { sections } = $.config.views;
  if (isNil2($.config.views.sections)) return;
  if (isObject(sections) && isEmpty2(sections)) return;
...
function authURL(domain) {
  ...
  if (!has2(api_token, $.env.vars)) api_token = api_token.toUpperCase();
  ...
  if (!has2(api_key, $.env.vars)) api_key = api_key.toUpperCase();
  if (!has2(api_secret, $.env.vars)) api_secret = api_secret.toUpperCase();
  ...
  throwError(`Invalid or missing ${cyan2(domain + ".myshopify.com")} credentials`, [
    `Your shop credentials in the ${cyan2.bold((0, import_pathe23.basename)($.env.file))} file could`,
...
function getResolvedPaths(filePath, hook) {
  ...
  if (isArray2(filePath)) {
    ...
    for (const item of filePath) {
      ...
      const resolved = import_fast_glob6.default.sync(uri, {
        cwd,
        absolute: true
      });
      if (match2) {
    ...
    return match2 === false ? paths2 : { paths: paths2, match: (0, import_anymatch3.default)(match2) };
  }
  if (isString(filePath)) {
    const uri = path2(filePath);
    const paths2 = import_fast_glob6.default.sync(uri, { cwd });
    if (paths2.length === 0) {
    ...
    if (paths2) {
      if (opts.flatten) {
        return paths2.map((input) => opts.assertSnippet ? {
          input,
          rename: (0, import_pathe23.basename)(input),
          snippet: false
        } : {
          input,
          rename: (0, import_pathe23.basename)(input)
      ...
      for (const prop in transforms) {
        ...
        if (isString(option)) {
          ...
          if (option.every(isString)) {
            ...
            if (hasRenameNamespace(prop)) record.rename = (0, import_pathe23.basename)(prop);
            if (paths2) {
              if (opts.flatten) {
                for (const input of paths2) {
                  config.push(assign({}, record, { input }));
...
async function getConfigFilePath(filename) {
  for (const ext of CONFIG_FILE_EXT) {
    ...
    const fileExists = await (0, import_fs_extra20.pathExists)(filepath);
...
function renameFile2(src, rename) {
  ...
  const ext = (0, import_pathe23.extname)(src);
  const file = (0, import_pathe23.basename)(src, ext);
...
async function setPaths() {
  ...
  for (const key of PATH_KEYS) {
    ...
    if (key === "customers") {
      ...
      uri = has3(key) ? isArray2($.config.paths[key]) ? $.config.paths[key].map(path2) : [path2($.config.paths[key])] : [path2("schema/*")];
    } else if (has3(key)) {
      uri = isArray2($.config.paths[key]) ? $.config.paths[key].map(path2) : [path2($.config.paths[key])];
      if (key === "snippets") {
        for (const p of uri) {
          $.snippet.baseDir.add(lastPath((0, import_pathe24.dirname)(p)));
        }
      } else if (key === "sections") {
        for (const p of uri) {
          $.section.baseDir.add(lastPath((0, import_pathe24.dirname)(p)));
        }
      } else if (key === "assets") {
        uri.push((0, import_pathe24.join)($.dirs.output, "assets/*"));
      }
    } else if (key === "redirects" && has3(key)) {
      uri = [(0, import_pathe24.join)($.cwd, $.config.paths[key])];
    } else {
      uri = [path2(key)];
    }
    for (const p of uri) {
      if (key !== "metafields" && key !== "redirects") {
        const paths2 = await (0, import_fast_glob7.default)(p, { cwd: $.cwd });
        if (paths2.length === 0) {
          if (key === "assets" && p === (0, import_pathe24.join)($.dirs.output, "assets/*")) continue;
        } else {
      ...
      $.paths[key].match = (0, import_anymatch4.default)(uri);
    }
  }
}
...
function setVersion(cli) {
  ...
  if ($.cache.build.themeVersion !== $.pkg.number) {
    ...
    $.vc.update.dir = (0, import_pathe25.join)($.dirs.export, `v${$.vc.major}`);
    $.vc.update.zip = (0, import_pathe25.join)($.vc.update.dir, `${$.vc.number}.zip`);
    const { patch, minor, major } = parseVersionNumber($.cache.build.themeVersion);
    $.vc.number = $.cache.build.themeVersion;
    $.vc.patch = patch;
    $.vc.minor = minor;
    $.vc.major = major;
    $.vc.dir = (0, import_pathe25.join)($.dirs.export, `v${$.vc.major}`);
    $.vc.zip = (0, import_pathe25.join)($.vc.dir, `${$.vc.number}.zip`);
  } else {
  ...
  if (cli.release !== null) {
    ...
    if (cli.release === "patch") {
      ...
      $.vc.update.dir = (0, import_pathe25.join)($.dirs.export, `v${$.vc.update.major}`);
    }
    $.vc.update.number = `${$.vc.update.major}.${$.vc.update.minor}.${$.vc.update.patch}`;
    $.vc.update.zip = (0, import_pathe25.join)($.vc.update.dir, `${$.vc.update.number}.zip`);
  }
}
...
async function setScriptOptions() {
  ...
  for (const script2 of transforms) {
    ...
    if (script2.snippet === true && rename.endsWith(".liquid") === false) {
    ...
    bundle.output = (0, import_pathe26.join)($.dirs.output, keyDir, rename);
    bundle.key = (0, import_pathe26.join)(keyDir, rename);
    bundle.attrs = [];
    bundle.size = NaN;
    bundle.watch = null;
    ...
    if (has3("esbuild")) {
      if (isBoolean(script2.esbuild) || isNil2(script2.esbuild)) {
        if (isEmpty2(esbuildOptions)) {
          bundle.esbuild = $.processor.esbuild;
        } else {
          bundle.esbuild = merge($.processor.esbuild, esbuildOptions);
        }
        ...
        if (isEmpty2(esbuildOptions)) {
          ...
          bundle.esbuild = merge($.processor.esbuild, script2.esbuild, esbuildOptions);
        }
      } else {
        typeError({
          option: "script",
    ...
    if ($.mode.terse) {
      bundle.esbuild = merge(bundle.esbuild, $.terser.script, {
        exclude: void 0
      });
    }
    $.script.push(bundle);
...
async function setStyleConfig() {
  ...
  for (let i = 0; i < styles2.length; i++) {
    ...
    if (has3("tailwind")) {
      ...
      if (override || isBoolean(style2.tailwind) && style2.tailwind !== false && isNil2(style2.tailwind) === false) {
        ...
        if (isArray2(tw.content) && isEmpty2(tw.content)) {
          tw.content = [(0, import_pathe27.join)($.dirs.input, "**", "*.{js,ts,jsx,tsx,vue,svelte,liquid,json,schema}")];
        }
        ...
        if ($.mode.watch && isArray2(bundle.tailwind.content)) {
          const files = await (0, import_fast_glob8.default)(bundle.tailwind.content);
    ...
    if (has3("sass") && style2.sass !== false && $.processor.sass.installed === true) {
            ...
            if (option === "sourcemap" || option === "warnings" || option === "quietDeps") {
              ...
              if (isArray2(style2.sass[option])) {
                ...
                for (const path3 of style2.sass[option]) {
                  const resolve3 = (0, import_pathe27.join)($.cwd, path3);
      ...
      if (style2.snippet === false && !/\.s[ac]ss/.test((0, import_pathe27.extname)(bundle.input))) {
    ...
    if ($.mode.watch && has3("watch")) {
      ...
      for (const uri of style2.watch) {
        const globs = await (0, import_fast_glob8.default)((0, import_pathe27.join)($.cwd, path2(uri)));
    ...
    if (isObject(bundle.sass)) {
      bundle.sass.include.unshift($.cwd, (0, import_pathe27.join)($.cwd, rename.dir));
      if (hasPath("sass.include", style2)) {
        bundle.sass.include = style2.sass.include.map((p) => (0, import_pathe27.join)($.cwd, p));
      }
    }
    if (has3("snippet")) {
    ...
    if (bundle.snippet) {
      ...
      if ($.mode.watch) {
        $.watch.unwatch((0, import_pathe27.join)($.dirs.output, "snippets", bundle.rename));
      }
    } else {
      bundle.rename = rename.name;
      if ($.mode.watch) {
        $.watch.unwatch((0, import_pathe27.join)($.dirs.output, "assets", rename.name));
      }
    }
    $.style.push(bundle);
  }
...
async function setSvgOptions() {
  ...
  for (const svg2 of svgs) {
    const files = svg2.input.filter((path2) => {
      if ((0, import_pathe28.extname)(path2) === ".svg") return true;
      warn3("Excluded file which is not an SVG type", (0, import_pathe28.relative)($.cwd, path2));
      return false;
    });
    if (files.length === 0) {
  ...
  if (typeof $.config.terser === "object") {
    for (const key in $.config.terser) {
      ...
      if (isBoolean($.config.terser[key])) {
        ...
        if (isEmpty2(terser2[key])) continue;
        for (const opt in $.config.terser[key]) {
          ...
          if (!has2(opt, terser2[key])) unknownError(`terser.${key}`, opt);
          if (opt === "mangleProps") {
...
function setPageOptions() {
  ...
  if (isEmpty2(pages)) return;
  const has3 = hasProp(pages);
  for (const option in pages) {
    if (!has3(option)) unknownError("pages", option);
    if (option === "language") {
      ...
      if (isNil2(pages[option])) continue;
      if (isString(pages[option])) {
        $.page[option] = pages[option];
      } else {
        typeError({
...
function setProcessors() {
  if (has2("processors", $.config) && isObject(process.config)) {
    for (const prop in $.config.processors) {
      if (isEmpty2($.config.processors[prop])) continue;
...
async function setup() {
  ...
  const { ngrok: ngrok2 } = await (0, import_enquirer3.prompt)({
    type: "input",
    name: "ngrok",
    required: true,
    message: messages[3],
